    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                <li>
                    <a href="" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>作业列表</a>
                <li>
                <li>
                    <a href="" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>上传共享资料</a>
                <li>
            </ul>
                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" disabled class="form-control" name="username" placeholder="" value="<?php echo ($vo["username"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="college" placeholder="" value="<?php echo ($vo["college"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <input type="hidden" name="t_id" value="<?php echo ($vo["t_id"]); ?>"/>
                        <div class="form-group">
