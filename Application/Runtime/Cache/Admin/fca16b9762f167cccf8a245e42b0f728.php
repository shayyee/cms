    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                <li>
                    <a href="<?php echo U('Homework/add');?>" class="active-menu waves-effect waves-dark"><i class="fa fa-sitemap"></i>发布作业</a>
                <li>
                <li>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="classid" id="classname" style="height:40px;">
                                    <?php if(is_array($classes)): foreach($classes as $key=>$c): ?><option value="<?php echo ($c["class_id"]); ?>"><?php echo ($c["classname"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea class="input js-editor" id="editor_singcms" name="content" style="width:700px;height:300px;"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="endtime" class="col-sm-2 control-label">截止时间:</label>
                            <div class="col-sm-5">
                                <input id="endtime" name="endtime" readonly class="laydate-icon" style="width:230px;">
                            </div>
                        </div>
