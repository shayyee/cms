        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="<?php echo U('Course/index');?>">课程管理</a>
                        </li>
                        <li class="active">
            ...
            <div class="search_type cc mb10">
                <form action="<?php echo U('Admin/Course/index');?>" method="POST">
                    <ul>
                        <li><label>课号</label><input name="cno" type="text" class="input length_2 mr10"></li>
                        <li><label>课程名称</label><input name="cname" type="text" class="input length_2 mr10"></li>
                        <li><label>任课老师</label><input name="tname" type="text" class="input length_2 mr10"></li>
                    ...
                    <div class="table-responsive">
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <tbody>
                                <?php if(is_array($courses)): $i = 0; $__LIST__ = $courses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>

                                        <td><?php echo ($vo["course_id"]); ?></td>
                                        <td><?php echo ($vo["cno"]); ?></td>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td><?php echo ($vo["realname"]); ?></td>
                                        <td><?php echo (isThumb($vo["picpath"])); ?></td>
                                        <td>
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["course_id"]); ?>" id="singcms-edit" attr-a="course" attr-message="编辑">
                                                <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                            </a>
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["course_id"]); ?>" id="singcms-delete"  attr-a="course" attr-message="删除">
...
<script>
    var SCOPE = {
        'add_url':'/Admin/Course/add.html',
        'edit_url' : '/Admin/Course/edit.html',
        'delete_url' : '/Admin/Course/delete',
        'import_url' : '/Admin/Course/import',
        'index_url' : '/Admin/Course',
    };
</script>
