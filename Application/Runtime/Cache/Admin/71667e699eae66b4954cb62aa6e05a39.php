                            ...
                            <form id="singcms-listorder">
                                <table class="table table-bordered table-hover singcms-table">
                                    ...
                                    <?php if(is_array($admins)): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" attr-id="<?php echo ($vo["admin_id"]); ?>" id="singcms-edit" attr-a="admin" attr-message="编辑">
                                                    <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                                </a>
                                                <a href="javascript:void(0)" attr-id="<?php echo ($vo["admin_id"]); ?>" id="singcms-delete"  attr-a="admin" attr-message="删除">
...
<script>
    var SCOPE = {
        'add_url':'/Admin/Manager/add.html',
        'edit_url' : '/Admin/Manager/edit',
        'delete_url' : '/Admin/Manager/delete',
        'index_url' : '/Admin/Manager',
    };
</script>
