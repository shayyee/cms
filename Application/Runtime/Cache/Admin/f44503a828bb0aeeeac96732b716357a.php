    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li>
                    <a href="<?php echo U('Donehw/index');?>" class="active-menu waves-effect waves-dark"><i class="fa fa-sitemap"></i>已交作业</a>
                <li>
                <li>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="search_type cc mb10">
                <form action="<?php echo U('Admin/Donehw/index');?>" method="POST">
                    <ul>
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($homeworks)): $i = 0; $__LIST__ = $homeworks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($vo["dhw_id"]); ?></td>
                                        <td><?php echo ($vo["title"]); ?></td>
                                        <td><?php echo ($vo["classname"]); ?></td>
                                        <td><?php echo ($vo["sno"]); ?></td>
                                        <td><?php echo ($vo["updatetime"]); ?></td>
                                        <?php if($vo["status"] == 0): ?><td style="color: red;">未批改</td>
                                            <?php else: ?><td>已批改</td><?php endif; ?>
                                        <td>
