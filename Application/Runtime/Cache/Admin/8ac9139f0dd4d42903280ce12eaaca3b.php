    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="<?php echo U('Student/index');?>" class="active-menu waves-effect waves-dark"><i class="fa fa-sitemap"></i>学生管理</a>
                </li>
                <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="<?php echo U('Student/index');?>">学生管理</a>
                        </li>
                        <li class="active">
            ...
            <div class="search_type cc mb10">
                <form action="<?php echo U('Admin/Student/index');?>" method="POST">
                    <ul>
                        <li><label>学号</label><input name="sno" type="text" class="input length_2 mr10"></li>
                        <li><label>姓名</label><input name="realname" type="text" class="input length_2 mr10"></li>
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($students)): $i = 0; $__LIST__ = $students;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["s_id"]); ?>" id="singcms-edit" attr-a="teacher" attr-message="编辑">
                                                <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                            </a>
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["s_id"]); ?>" id="singcms-delete"  attr-a="teacher" attr-message="删除">
...
<script>
    var SCOPE = {
        'add_url':'/Admin/Student/add.html',
        'edit_url' : '/Admin/Student/edit.html',
        'delete_url' : '/Admin/Student/delete',
        'import_url' : '/Admin/Student/import',
        'index_url' : '/Admin/Student',
    };
</script>
