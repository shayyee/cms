                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form" style="margin-top: 0">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="filename" class="form-control" id="inputtitle" value="<?php echo ($vo["filename"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="classname" class="col-sm-2 control-label">所属课程:</label>
                            <div class="col-sm-5">
                                <select class="form-control" name="courseid" id="classname" style="height:40px;">
                                    <?php if(is_array($courses)): foreach($courses as $key=>$c): ?><option value="<?php echo ($c["course_id"]); ?>" <?php if($c['course_id'] == $vo['course_id']): ?>selected="selected"<?php endif; ?>><?php echo ($c["name"]); ?>(<?php echo ($c["cno"]); ?>)</option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="status" class="form-control select">
                                    <?php if($vo["status"] == 1): ?><option selected="selected" value="1">正常</option>
                                        <option value="0">禁用</option><?php endif; ?>
                                    <?php if($vo["status"] == 0): ?><option value="1">正常</option>
                                        <option selected="selected" value="0">禁用</option><?php endif; ?>
                                </select>
                            </div>
                        </div>
                        <input type="hidden" name="share_id" value="<?php echo ($vo["share_id"]); ?>"/>
