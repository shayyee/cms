    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="<?php echo U('Class/index');?>" class="active-menu waves-effect waves-dark"><i class="fa fa-sitemap"></i>班级管理</a>
                </li>
                <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="<?php echo U('Class/index');?>">班级管理</a>
                        </li>
                        <li class="active">
            ...
            <div class="search_type cc mb10">
                <form action="<?php echo U('Admin/Class/index');?>" method="POST">
                    <ul>
                        <li><label>班级</label><input name="classname" type="text" class="input length_2 mr10"></li>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="table-responsive">
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table" style="font-size: 14px;">
                                <thead>
                                <tr>
                                    <th>id</th>
                                    <th>班级名称</th>
                                ...
                                <tbody>
                                <?php if(is_array($classes)): $i = 0; $__LIST__ = $classes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>

                                        <td><?php echo ($vo["class_id"]); ?></td>
                                        <td><?php echo ($vo["classname"]); ?></td>
                                        <td><?php echo (getIssueById($vo["issue"])); ?></td>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td>
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["class_id"]); ?>" id="singcms-edit" attr-a="class" attr-message="编辑">
                                                <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                            </a>
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["class_id"]); ?>" id="singcms-delete"  attr-a="class" attr-message="删除">
...
<script>
    var SCOPE = {
        'add_url':'/Admin/Class/add.html',
        'edit_url' : '/Admin/Class/edit.html',
        'delete_url' : '/Admin/Class/delete',
        'index_url' : '/Admin/Class',
    };
</script>
