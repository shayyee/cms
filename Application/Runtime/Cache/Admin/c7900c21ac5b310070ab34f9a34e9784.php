    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>教师管理</a>
                <li>
                <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i>  <a href="javascript:void(0)">管理员管理</a>
                        </li>
                        <li class="active">
                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" disabled class="form-control" name="realname" placeholder="" value="<?php echo ($vo["username"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="password" placeholder="留空则不修改" value="">
                            </div>
                        </div>
                        <div class="form-group">
