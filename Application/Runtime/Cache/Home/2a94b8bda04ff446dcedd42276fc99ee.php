    ...
    <div class="clearfix">
        <article class="u-m-c-w837 u-m-center">
            <section class="u-m-c-wrap">
                ...
                <section class="line1">
                    <!--若无学习记录-->
                    <?php if($homeworks == null): ?><div style="margin-top:80px">
                            <div style="background: url('/Public/img/nothing.png') center no-repeat;height:260px;"></div>
                            <h2 style="text-align:center;padding-left:40px;font-size:16px;">您的作业都已完成！</h2>
                        </div><?php endif; ?>
                    <!--作业列表-->
                    <?php if($homeworks != null): ?><table class="table table-bordered table-hover singcms-table">
                            <thead>
                            <tr>
                                <th>作业</th>
                                <th>所属班级</th>
                            ...
                            <?php if(is_array($homeworks)): $i = 0; $__LIST__ = $homeworks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <input type="text" hidden value="<?php echo ($vo["hw_id"]); ?>">
                                        <button type="button" class="btn btn-primary">做作业</button>
                                    </td>
...
<script>
    $('.btn').click(function () {
        ...
        window.location.href = '/Home/Homework/detail.html?id='+hw_id;
    })
